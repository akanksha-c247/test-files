    ...
    <div className="grad1">
      <div className="col-6">
        ...
        <a
          ...
          ><span class="span">waste collections key performance indicators</span></a>
        </p>
        <Button className='buttonText' label="Give Us A Call&nbsp;&nbsp;(571) 316-0676" arrowColor="white" textColor="#007bff" backgroundColor="#8CC63F" borderColor="#379ACD" height='50px' width='400px'/>
      </div>
      <div className="col-6">
